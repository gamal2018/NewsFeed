...
public class ArticleActivity extends AppCompatActivity implements LoaderCallbacks<List<Article>> {
    ...
    public Loader<List<Article>> onCreateLoader(int i, Bundle bundle) {
        ...
        String keyValue = sharedPrefs.getString(
                getString(R.string.settings_key_value),
                getString(R.string.settings_key_value_default));
        ...
        uriBuilder.appendQueryParameter("api-key", keyValue);
